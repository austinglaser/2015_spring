...
def ast_print_py(n):
    ...
    # Print <func name>([<arg[0]>[, <arg[1][...]]])
        ...
        ast_print_py(n.node)
        # Any name is printed with a trailing space, for consistency.
        # However, we want the function's parens to be tight. So, we print
        # a backspace to get rid of that pesky space
        sys.stdout.write("\b(")
