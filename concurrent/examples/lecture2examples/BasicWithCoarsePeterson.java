public class BasicWithCoarsePeterson implements Runnable {
    ...
    public BasicWithCoarsePeterson(int newMe) {
        me = newMe;
	flag0 = 0;
	flag1 = 0;
	victim = 0;
	...
	long startTime = System.nanoTime();
	    ...
	    Thread t1 = new Thread(new BasicWithCoarsePeterson(0));
	    Thread t2 = new Thread(new BasicWithCoarsePeterson(1));
